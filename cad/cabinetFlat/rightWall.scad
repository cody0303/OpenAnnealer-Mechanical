...
//   python tools/export_panel_dxf.py cad/cabinetFlat/rightWall.scad
...
features = hand > 0 ? faceFeatures("right") : mirror_features(faceFeatures("right"));
...
lapXs = hand > 0 ? faceLapXs("right") : [for (x = faceLapXs("right")) -x];
